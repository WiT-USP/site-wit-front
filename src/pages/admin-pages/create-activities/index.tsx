...
import CertificadosAdmin from "../certificados";
...
const CertficadosAdmin: React.FC = () => {
                ...
                <form onSubmit={handleSubmit}>
                    <div className="primeira-linha">
                        ...
                        <label id="label-hora-inicio" className="label-event">
                            Hora de inicio:
                            <input type="text" name="hora_inicio" value={formValues.hora_inicio} onChange={handleInputChange} placeholder="XX:XX"/>
                        </label>
                        <label id="label-hora-fim" className="label-event">
                            Hora de término:
                            <input type="text" name="hora_fim" value={formValues.hora_fim} onChange={handleInputChange} placeholder="XX:XX"/>
                        </label>
                    </div>
                    ...
                    <div className="segunda-linha">
                        <label id="label-responsavel" className="label-event">
                            Responsável:
                            <input type="text" name="responsavel" value={formValues.responsavel} onChange={handleInputChange} placeholder="Nome Sobrenome"/>
                        </label>
                        <label id="label-data-final" className="label-event">
                            Inscrições até:
                            <input type="text" name="data_final" value={formValues.data_final} onChange={handleInputChange} placeholder="DD/MM/AAAA"/>
                        </label>
