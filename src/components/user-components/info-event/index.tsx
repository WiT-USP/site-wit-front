    ...
    return (
        <Container>
            <div className="column">
                ...
                <p>
                    <span>EVENTO: </span>Mulheres na Engenharia<br/>
                    <span>DATA: </span>23/11/23<br/>
                    <span>HORÁRIO: </span>19hs às 21h<br/>
                    <span>COFFEE: </span><a href="#">[URL]</a><br/>
                    <span>FOTOS: </span><a href="#">[URL]</a><br/>
                </p>
            </div>
